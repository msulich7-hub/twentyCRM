> **Kopia wlasna** — pelne zrodla Twenty CRM w repozytorium [msulich7-hub/twentyCRM](https://github.com/msulich7-hub/twentyCRM). Mozesz dowolnie modyfikowac i pushowac zmiany. Oryginal: [twentyhq/twenty](https://github.com/twentyhq/twenty).
